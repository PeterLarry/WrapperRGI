...
//	vvvvvvvvvvvvvv FACTORS vvvvvvvvvvvvvv
	private void getFactorsWsUnitInstance(WsUnitInstance unitInstance)
	{
		...
		factorTest = new WsFactor();factorTest.setCode("SXTOT");factorTest.setValue("1");unitInstance.getFactors() .add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("FRRCA");factorTest.setValue(null);unitInstance.getFactors() .add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("QDRCA");factorTest.setValue(null);unitInstance.getFactors() .add(factorTest);
	}
	
	private void getFactorsAssetInstances(WsAssetInstance assetInstances)
	{
		WsFactor factorTest;
		factorTest = new WsFactor();factorTest.setCode("2USOVE");factorTest.setValue("1");assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("2CLUWR");factorTest.setValue("2");assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("1PHAP");factorTest.setValue("0");assetInstances.getFactors().add(factorTest);
		...
		factorTest = new WsFactor();factorTest.setCode("_2PRCA");factorTest.setValue("00018");assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("_2CETA");factorTest.setValue("18");assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("_2CRCA");factorTest.setValue("00018");assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("2MDPR");factorTest.setValue("2");assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("2MDAP");factorTest.setValue("2");assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("2RD1ET");factorTest.setValue(null);assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("2RD1CA");factorTest.setValue(null);assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("2NDRIV");factorTest.setValue("2");assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("2ETAV");factorTest.setValue("0");assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("2EVACQ");factorTest.setValue("1");assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("2ANUCF");factorTest.setValue("2");assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("2ALAUT");factorTest.setValue("False");assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("3CLIN1");factorTest.setValue("False");assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("_2CU");factorTest.setValue("1");assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("2OWAP");factorTest.setValue("0");assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("2BERSP");factorTest.setValue("False");assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("1FIDRC");factorTest.setValue("1");assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("2ASSIN");factorTest.setValue("1");assetInstances.getFactors().add(factorTest);
		factorTest = new WsFactor();factorTest.setCode("1FRRIN");factorTest.setValue(null);assetInstances.getFactors().add(factorTest);
	}
	...
	private void getFactorsWsProduct(WsProduct wsProduct)
	{
		...
		factorTest = new WsFactor();factorTest.setCode("_1CNCA");factorTest.setValue("00018");wsProduct.getFactors().add(factorTest );
		factorTest = new WsFactor();factorTest.setCode("_2BM");factorTest.setValue("2");wsProduct.getFactors().add(factorTest );
	}
